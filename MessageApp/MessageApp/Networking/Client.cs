...
namespace Networking.Client
{
    ...
    public static class Client
    {
        ...
        {
            ClientSend.SendChat(message);
        }

        private static void InitializeClientData() {
            PacketHandlers = new Dictionary<int, PacketHandler>() {
                { (int)ServerPackets.AssignID, ClientReceive.AssignID },
                { (int)ServerPackets.DistributeChat, ClientReceive.ReadChat  },
            };
        ...
        private static class ClientReceive
        {
            ...
            public static void ReadChat(Packet packet)
            {
                Form1.Instance.CreateMessage(packet);
            }
        ...
        private static class ClientSend
        {
            ...
            {
                using (Packet packet = new Packet((int)ClientPackets.SendChat))
                {
